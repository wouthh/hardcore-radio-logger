...
- Tentative Spotify review additions (`status='review'` and `in_playlist=1`) must not trigger global tombstone cascades when removed from Spotify because they are uncertain matches.
